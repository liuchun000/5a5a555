...
/* uif04771 20240310 software version ID */
static const uint8 gs_aReadSwVersionId[] = {0x22u, 0xF1u, 0xAAu};

/* Check preprogramming condition */
static const uint8 gs_aCheckPreProgrammingConditionId[] = {0x31u, 0x01u, 0x02u, 0x01u};
...
static void ReadDataByIdentifier(struct UDSServiceInfo *i_pstUDSServiceInfo, tUdsAppMsgInfo *m_pstPDUMsg)
{
    ...
    ASSERT(NULL_PTR == i_pstUDSServiceInfo);
    RequestSubfunction = m_pstPDUMsg->aDataBuf[1u];
    /* Is read software version id ? */
		if (1)
    //if (TRUE == IsCheckReadSwVersion(m_pstPDUMsg))  
    {
        m_pstPDUMsg->aDataBuf[0u] = i_pstUDSServiceInfo->SerNum + 0x40u;

//        m_pstPDUMsg->aDataBuf[3u] = Software_Version.sw_version_type.version.Build;
//        m_pstPDUMsg->aDataBuf[4u] = Software_Version.sw_version_type.version.Minor;
//        m_pstPDUMsg->aDataBuf[5u] = Software_Version.sw_version_type.version.Major;
//        m_pstPDUMsg->aDataBuf[6u] = Software_Version.sw_version_type.version.Resvd;
        m_pstPDUMsg->aDataBuf[3u] = 1;
        m_pstPDUMsg->aDataBuf[4u] = 2;
        m_pstPDUMsg->aDataBuf[5u] = 3;
        m_pstPDUMsg->aDataBuf[6u] = 4;			
...
static void RoutineControl(struct UDSServiceInfo *i_pstUDSServiceInfo, tUdsAppMsgInfo *m_pstPDUMsg)
{
    ...
    else if(TRUE == IsCheckPreProgrammingCondition(m_pstPDUMsg))
    {
        m_pstPDUMsg->aDataBuf[0u] = i_pstUDSServiceInfo->SerNum + 0x40u;
        m_pstPDUMsg->xDataLen = 4u;
    }
